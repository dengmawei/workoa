...
<script type="text/javascript">
	function subModule(){
		...
		$.post("${ctx}/overtime/staffManagerApprove.html",param,function(data){
			if(data.success){
					...
					<div class="widget-content nopadding">
						<form id="moduleForm" action="" method="post" class="form-horizontal">
							<div class="control-group">
								...
								<div class="controls">
									<label><input type="radio" name="status" value="1" checked="checked" disabled="disabled">同意</label>
									<label><input type="radio" name="status" value="0" disabled="disabled">驳回</label>
								</div>
							</div>
