...
<body>
	<div id="breadcrumb">
		...
		<a href="javascript:void(0)" class="current">编辑草稿</a>
	</div>
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form id="moduleForm" action="" method="post" class="form-horizontal">
							...
							<input type="hidden" id="flowId" value="${overtime.id }">
							<div class="control-group">
								<label class="control-label">开始时间</label>
								<div class="controls">
									<div class="input-append date" id="datetimepicker-start" data-date-format="yyyy-mm-dd hh:ii">
									    <input class="span2" type="text" name="startTime" id="startTime" readonly="readonly" value='<fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${overtime.startTime }"></fmt:formatDate>'>
							...
							<div class="control-group">
								...
								<div class="controls">
									<div class="input-append date" id="datetimepicker-end" data-date-format="yyyy-mm-dd hh:ii">
									    <input class="span2" type="text" name="endTime" id="endTime" readonly="readonly" value='<fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${overtime.endTime }"></fmt:formatDate>'>
									    <span class="add-on"><i class="icon-th"></i></span>
									</div>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<textarea rows="10" cols="20" name="reason" id="reason">${overtime.overtimeReason }</textarea>
								</div>
							</div>
